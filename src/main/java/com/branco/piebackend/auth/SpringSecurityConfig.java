package com.branco.piebackend.auth;

import com.branco.piebackend.auth.filter.JwtAuthenticationFilter;
import com.branco.piebackend.auth.filter.JwtValidationFilter;
...
public class SpringSecurityConfig {
    ...
    SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity.authorizeHttpRequests(authz ->
            authz.requestMatchers("/login", "/api/users/register").permitAll()
